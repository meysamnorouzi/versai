    ...
    <div className="w-full py-20 bg-[#f2f9ff]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center w-full">
          ...
          {/* Video section */}
          <div className="w-full max-w-[570px] h-48 sm:h-64 lg:h-80 bg-gradient-to-b from-black/0 to-[#1e3950] rounded-2xl relative mx-auto mb-6 sm:mb-8 flex items-end justify-start p-4 sm:p-6">
