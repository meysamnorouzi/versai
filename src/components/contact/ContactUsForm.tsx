            ...
            <div className="w-full max-w-4xl px-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="text-center">
                  <button
                    type="submit"
                    className="bg-[#d74a3c] border border-[#e5867d] text-[#f2f9ff] px-6 py-3 rounded-[32px] text-[18px] font-bold font-['IRANYekanX'] hover:bg-[#c0392b] transition-colors duration-200 leading-[1.1]"
                  >
                    ارسال درخواست
                  </button>
                </div>
              ...
              <div className="mt-8 text-center">
                ...
                <button className="bg-[#f2f9ff] border border-[#d74a3c] text-[#d74a3c] px-6 py-3 rounded-[32px] text-[18px] font-bold font-['IRANYekanX'] hover:bg-[#e8f4f8] transition-colors duration-200 inline-flex items-center gap-2 leading-[1.1]">
                  <div className="w-6 h-6 flex items-center justify-center">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
