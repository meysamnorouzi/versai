...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'مهاجرت به آلمان | موسسه مهاجرتی ورسای',
    description: 'راهنمای کامل مهاجرت به آلمان، انواع ویزا، شرایط اقامت',
    url: 'https://versai.ir/germany',
    type: 'website',
  },
  alternates: {
    canonical: 'https://versai.ir/germany',
  },
}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-start">
            <div className="order-2 lg:order-1">
              <img 
                src="/images/shared/photo_2026-06-18_10-13-44.jpg" 
                alt="پرچم آلمان"
      ...
      <section className="py-8 sm:py-12 md:py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-start">
            ...
            <div className="space-y-4 sm:space-y-6">
              <img 
                src="/images/shared/photo_2026-06-18_10-13-47.jpg" 
                alt="منظره فرانکفورت آلمان"
