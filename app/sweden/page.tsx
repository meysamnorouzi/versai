...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'مهاجرت به سوئد | موسسه مهاجرتی ورسای',
    description: 'راهنمای کامل مهاجرت به سوئد، انواع ویزا، شرایط اقامت',
    url: 'https://versai.ir/sweden',
    type: 'website',
  },
  alternates: {
    canonical: 'https://versai.ir/sweden',
  },
}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="max-w-4xl mx-auto text-right">
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-[18px] font-medium text-[#6d6e70] leading-[1.53] mb-4 sm:mb-6">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-start">
            <div className="order-2 lg:order-1">
              <img 
                src="/images/shared/photo_2026-06-18_10-13-55.jpg" 
                alt="پرچم سوئد"
      ...
      <section className="py-8 sm:py-12 md:py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-start">
            ...
            <div className="space-y-4 sm:space-y-6">
              <img 
                src="/images/shared/photo_2026-06-18_10-13-57.jpg" 
                alt="منظره شهری سوئد"
